...
function UserReg(props) {
 // The first commit of Material-UI
    ...
    const onSubmit =  (values) => {
        axios.post('https://jobday.az/api/register-jobseeker', {name: values.name , surname: values.surname, email: values.email ,  phone: values.phone , password: values.password,  password_confirmation:values.confirmPassword } , headers)
        ...
        <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit} validateOnChange={true} validateOnBlur={false}>
            <Form  className="formUser" method="POST">
                ...
                <div className="errors">
                    <Field placeholder={sessionStorage.getItem('lang') === "AZ" && `Adınız ` || sessionStorage.getItem('lang') === "EN" && `Name ` || sessionStorage.getItem('lang') === "RU" && `Имя `}  name="name" className="input"/>
                    <ErrorMessage name="name"/>
                </div>
                
                <div className="errors">
                    <Field placeholder={sessionStorage.getItem('lang') === "AZ" && ` Soyadınız` || sessionStorage.getItem('lang') === "EN" && ` Surname` || sessionStorage.getItem('lang') === "RU" && ` Фамилия`}  name="surname" className="input"/>
