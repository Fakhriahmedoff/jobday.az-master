            ...
            <div className="premiumCard">
                ...
                <div className="aboutCont">
                    ...
                    <div className="top">
                        ...
                        <p className="part2">{(props.salary !== null && props.salary !== undefined) ? (props.salary + " AZN") : <img title={sessionStorage.getItem('lang') === "AZ" && `razılaşma yolu ilə` || sessionStorage.getItem('lang') === "EN" && `by consent` || sessionStorage.getItem('lang') === "RU" && `по согласию`} alt='by consent' width='25px' height='auto' src={handshake} alt="" />}</p>
                    </div>
