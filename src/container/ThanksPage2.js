...
function ThanksPage() {
    ...
    const sendPostReq = async () => {
        try {
            ...
            {
                const resp = await axios.post('https://jobday.az/api/create_invoice_two' , {
                    ...
                    transaction_id:`qaime${Math.floor(100000 + Math.random() * 900000)}`
                })
        ...
        <div className="ThanksPage2">
            <div className="ThanksCont">
                <div className='billAndText'>
                    ...
                    <p className="billAbout">{localStorage.getItem('type') === 'vacancy' && lang?.text_vac2}</p>
